...
cox_sentinel_lineage_params <- coxph_params(cox_sentinel,cox_dat)
...
ggsave('output/rich_vaccination/fixed_case_hospitalization_variant_relRisk.png',units='in',width=5,height=3,device='png')
ggsave('output/rich_vaccination/fixed_case_hospitalization_variant_relRisk.svg',units='in',width=5,height=3,device='svg')

cox_sentinel_vaccine_params <- coxph_params(cox_sentinel,cox_dat,group='vaccination_active')

ggplot() +
  geom_pointrange(data=cox_sentinel_vaccine_params,aes(y=vaccination_active,x=logRR,xmin=lower95,xmax=upper95),color='blue') +
  geom_vline(aes(xintercept=0),linetype='dashed') +
...
cox_fixed_sentinel_vax_rel_risk %>%
  kbl() %>% 
...
hosp_counts %>%
  kbl() %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = F) %>%
  save_kable(file = "output/rich_vaccination/fixed_cases_and_hosps.png",
             density=600,zoom=3) 
write.table(hosp_counts,'output/rich_vaccination/fixed_variant_severity_cases_and_hosp.csv',sep=',',row.names = FALSE)
...
ggsave('output/rich_vaccination/fixed_km_curves.png',units='in',width=5,height=3,device='png')
...
ggsave('output/rich_vaccination/fixed_case_hospitalization_age_relRisk.png',units='in',width=5,height=3,device='png')
ggsave('output/rich_vaccination/fixed_case_hospitalization_age_relRisk.svg',units='in',width=5,height=3,device='svg')

# race ADDING THIS BACK IN FOR REVIEWERS
#### 

cox_sentinel_race_and_county <- coxph(hosp_surv ~ who_lineage + 
                                        age_bin + SEX_AT_BIRTH +
                                        vaccination_active + week_collection_number + race + COUNTY, 
                                      data=cox_dat,
                                      x=FALSE,y=FALSE)
...
cox_sentinel_race_lineage_params <- coxph_params(cox_sentinel_race_and_county,cox_dat,group='who_lineage')
cox_sentinel_race_params <- coxph_params(cox_sentinel_race_and_county,cox_dat,group='race')
...
ggplot() +
  ...
  ylab('') +
  xlab('hazard ratio for hospitalization') 
ggsave('output/rich_vaccination/fixed_case_hospitalization_race_sens.png',units='in',width=5,height=3,device='png')
ggsave('output/rich_vaccination/fixed_case_hospitalization_race_sens.svg',units='in',width=5,height=3,device='svg')
...
ggsave('output/rich_vaccination/fixed_case_hospitalization_race_relRisk.png',units='in',width=5,height=3,device='png')
ggsave('output/rich_vaccination/fixed_case_hospitalization_race_relRisk.svg',units='in',width=5,height=3,device='svg')

# county ADDING THIS BACK IN FOR REVIEWERS
#### 


cox_sentinel_county_lineage_params <- coxph_params(cox_sentinel_race_and_county,cox_dat,group='who_lineage')
cox_sentinel_county_params <- coxph_params(cox_sentinel_race_and_county,cox_dat,group='COUNTY')
...
ggplot() +
  ...
  ylab('') +
  xlab('hazard ratio for hospitalization') 
ggsave('output/rich_vaccination/fixed_case_hospitalization_county_sens.png',units='in',width=5,height=3,device='png')
ggsave('output/rich_vaccination/fixed_case_hospitalization_county_sens.svg',units='in',width=5,height=3,device='svg')
...
ggsave('output/rich_vaccination/fixed_case_hospitalization_county_relRisk.png',units='in',width=5,height=3,device='png')
ggsave('output/rich_vaccination/fixed_case_hospitalization_county_relRisk.svg',units='in',width=5,height=3,device='svg')

# sex
cox_sentinel_sex_params <- coxph_params(cox_sentinel,cox_dat,group='SEX_AT_BIRTH')
...
ggsave('output/rich_vaccination/fixed_case_hospitalization_sex_relRisk.png',units='in',width=5,height=3,device='png')
ggsave('output/rich_vaccination/fixed_case_hospitalization_sex_relRisk.svg',units='in',width=5,height=3,device='svg')
...
# time only
cox_sentinel_time_only <- coxph(hosp_surv ~ #(1|who_lineage) + 
                                  age_bin + SEX_AT_BIRTH +
                                  vaccination_active + week_collection_number, 
                                data=cox_dat,
                                x=FALSE,y=FALSE)
...
cox_sentinel_time_only_vaccine_params <- coxph_params(cox_sentinel_time_only,cox_dat,group='vaccination_active')

# variant and NO time
cox_sentinel_voc_and_no_time <- coxph(hosp_surv ~ who_lineage + 
                                        age_bin + SEX_AT_BIRTH +
                                        vaccination_active , 
                                      data=cox_dat,
                                      x=FALSE,y=FALSE)
...
cox_sentinel_voc_and_no_time_vaccine_params <- coxph_params(cox_sentinel_voc_and_no_time,cox_dat,group='vaccination_active')
cox_sentinel_voc_and_no_time_lineage_params <- coxph_params(cox_sentinel_voc_and_no_time,cox_dat,group='who_lineage')
...
cox_sentinel_14 <- coxph(hosp_surv_14 ~ who_lineage + 
                           age_bin + SEX_AT_BIRTH +
                           vaccination_active + week_collection_number, 
                         data=cox_dat_14,
                         x=FALSE,y=FALSE)
...
cox_sentinel_lineage_params_14 <- coxph_params(cox_sentinel_14,cox_dat_14,group='who_lineage')
...
cox_sentinel_21 <- coxph(hosp_surv_21 ~ who_lineage + 
                           age_bin + SEX_AT_BIRTH +
                           vaccination_active + week_collection_number, 
                         data=cox_dat_21,
                         x=FALSE,y=FALSE)
...
cox_sentinel_lineage_params_21 <- coxph_params(cox_sentinel_21,cox_dat_21,group='who_lineage')
...
cox_sentinel_30 <- coxph(hosp_surv_30 ~ who_lineage + 
                           age_bin + SEX_AT_BIRTH +
                           vaccination_active + week_collection_number, 
                         data=cox_dat_30,
                         x=FALSE,y=FALSE)
...
cox_sentinel_lineage_params_30 <- coxph_params(cox_sentinel_30,cox_dat_30,group='who_lineage')
...
cox_all <- coxph(hosp_surv ~ who_lineage + 
                   age_bin + SEX_AT_BIRTH +
                   vaccination_active + week_collection_number,
                 data=cox_dat,
                 x=FALSE,y=FALSE)
...
cox_all_lineage_params <- coxph_params(cox_all,cox_dat)
...
cox_all_vaccine_params <- coxph_params(cox_all,cox_dat,group='vaccination_active')
...
pois_sentinel <- glmer(n_hosp ~ who_lineage + log(offset(cases)) + 
                         age_bin + SEX_AT_BIRTH+
                         vaccination_active +week_collection_number,
                       data=pois_dat,
                       family='poisson')
...
pois_all <- glmer(n_hosp ~ who_lineage + log(offset(cases)) + 
                    age_bin + SEX_AT_BIRTH + 
                    vaccination_active +week_collection_number,
                  data=pois_dat,
                  family='poisson')
